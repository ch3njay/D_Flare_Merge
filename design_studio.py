...
def render_color_palette_editor():
    ...
    with col1:
        ...
        # 主色調選擇
        primary_color = st.color_picker("主要色彩 (按鈕、重點)", "#FF6B2C")
        secondary_color = st.color_picker("次要色彩 (輔助元素)", "#1ABC9C")
        accent_color = st.color_picker("強調色彩 (警告、提示)", "#38bdf8")
        
        st.subheader("背景色系")
        bg_color = st.color_picker("主背景", "#FFFFFF")
        surface_color = st.color_picker("卡片背景", "#F8FAFC")
        border_color = st.color_picker("邊框顏色", "#E2E8F0")
        
    with col2:
        st.subheader("文字色彩")
        text_primary = st.color_picker("主要文字", "#1A202C")
        text_secondary = st.color_picker("次要文字", "#4A5568")
